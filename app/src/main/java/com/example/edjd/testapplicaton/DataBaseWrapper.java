...
public class DataBaseWrapper extends SQLiteOpenHelper {
    ...
    private static final String SQL_GENERATE_USER = "INSERT INTO user SELECT data.* FROM (select '1' AS user_id, 'UserOne' AS user_name, 'one@fake.it' AS user_email, '2016-01-01' AS user_create_date, '2016-01-01' AS user_verified_date, NULL AS user_deactivated_date UNION ALL SELECT '2', 'UserTwo', 'two@fake.it', '2016-01-02', '2016-01-02', NULL UNION ALL SELECT '3', 'UserThree', 'three@fake.it', '2016-01-03', '2016-01-03', NULL) as data LEFT JOIN user ON user.user_id = data.user_id WHERE user.user_id IS NULL;";
    //private static final String SQL_GENERATE_SCORE = "INSERT INTO score SELECT data.* FROM (select '1001' AS score_id, 101 AS game_id, 3 AS user_id, 54321 AS score_value, '2016-06-14' AS score_date UNION ALL SELECT 1002, 101, 2, 2468, '2016-06-14' UNION ALL SELECT 1003, 101, 1, 11111, '2016-06-14') as data LEFT JOIN score ON score.score_id = data.score_id WHERE score.score_id IS NULL;";
